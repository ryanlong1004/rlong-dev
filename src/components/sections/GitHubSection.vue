        ...
        <div class="view-all">
          <a href="https://github.com/ryanlong1004?tab=repositories" target="_blank" class="view-all-link">
            ...
            <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
              <path d="M3.75 2a.75.75 0 01.75.75v7.5a.75.75 0 01-1.5 0v-7.5A.75.75 0 013.75 2zm8.5 0a.75.75 0 01.75.75v7.5a.75.75 0 01-1.5 0v-7.5a.75.75 0 01.75-.75zm-4.25 0a.75.75 0 01.75.75v11.5a.75.75 0 01-1.5 0V2.75a.75.75 0 01.75-.75z"/>
            </svg>
          </a>
        </div>
      </div>
